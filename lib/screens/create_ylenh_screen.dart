...
class _CreateYLenhScreenState extends State<CreateYLenhScreen> {
  ...
  final TextEditingController bacSiController = TextEditingController();
  final TextEditingController dieuDuongController = TextEditingController();
            ...
            Center(
              child: ElevatedButton.icon(
                onPressed: () async {
                  ...
                  // TODO: Tùy máy gửi hay nhận: dùng startDiscovery để tìm thiết bị rồi gửi
                  ...
                  // Gửi y lệnh sau vài giây tìm endpoint (
